...
INBO experts explained us that the rings containing a `B` at third position are *virtual* rings (see [issue #81](https://github.com/inbo/cr-birding/issues/81#issuecomment-478954317)). We assign them the color blue as ring color, color white as inscription color and add note `virtual_ring.` to `sovon_bird_notes` as decided [here](https://github.com/inbo/cr-birding/issues/81#issuecomment-479365880):
