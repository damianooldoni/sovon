...
The field `user_role` cannot be filled at the moment: it will be mapped at the end of next chapter.
...
Save to csv file `crbirding_users.csv` in `./data/processed/` as SOVON prefers working with comma separated files than tab separated files:
