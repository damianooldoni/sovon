...
Some metal rings are not linked to an observation with action `rngme`, so we have not a date for them:
...
Check if all `bird_reference` are linked to one and only one `rngkl` action:
