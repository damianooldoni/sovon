...
We add column `bird_reference` to `obs_and_acts` as it will be needed to map the dates of ringing:
...
The reconstruction of the series of color rings linked to each bird is made by using columns `first_Nummer`, `raw_NummerNieuw` and the information from spreadsheets of experts. We will collect the needed information in new dataframe called `crbirding_birds`:
...
Example of mapping: the bird with `bird_reference` equal to 14 is associated to the following series of two rings:
