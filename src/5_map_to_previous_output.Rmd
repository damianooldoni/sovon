...
Based on patch related to [15#issuecomment-700596629](https://github.com/inbo/cr-birding/issues/15#issuecomment-700596629) we have removed all informations about CPAG, so it makes sense we don't fint it in new export.
